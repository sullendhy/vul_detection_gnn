...
def test(args, model, tokenizer):
    ...
    #新增假阳性率，假阴性率，acc计算不变，精度; 标签1有漏洞，标签0无漏洞
    true_vul = 0  #预测有漏洞中真正漏洞的数量
    true_non = 0  #预测没漏洞中真正没漏洞的数量
    false_vul = 0 #预测有漏洞中实际无漏洞的数量
    false_non = 0 #预测没漏洞中实际有漏洞的数量
    ...
    precision = true_vul / (true_vul + false_vul)
    recall = true_vul / (true_vul + false_non)
...
def main():
    ...
    parser.add_argument("--train_data_file", default="dataset/train_aug.jsonl", type=str,
                        help="The input training data file (a text file).")
    parser.add_argument("--output_dir", default="./saved_models", type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument('--epoch', type=int, default=42,  
                        help="training epoches")
    parser.add_argument("--model", default="GNNs", type=str,help="GNNs, devign")  # GNNs: our model ; devign: baseline
    parser.add_argument("--format", default="uni", type=str, help="uni, or index .idx for index-focused method, uni for unique token-focused method")
    parser.add_argument("--window_size", default=3, type=int, help="window_size to build graph")   # ablation study
    parser.add_argument("--remove_residual", default=False, action='store_true', help="remove_residual")    #
    parser.add_argument("--att_op", default='sum', type=str,  #
                        help="using attention operation for attention: mul, sum, concat")
    parser.add_argument("--num_GNN_layers", default=3, type=int, #
                        help="num GNN layers.")
    parser.add_argument("--tokenizer_name", default="microsoft/codebert-base", type=str,
                        help="microsoft/codebert-base or microsoft/graphcodebert-base Optional pretrained tokenizer name or path if not the same as model_name_or_path")
    ## Other parameters
    ...
    if args.model == "devign":
        ...
        model = vul_detection_gnn(model, config, tokenizer, args)   # 
